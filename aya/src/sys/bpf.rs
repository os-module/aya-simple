...
use aya_obj::{
    ...
    generated::{
        ...
        bpf_prog_info, bpf_prog_type,
    },
    obj, VerifierLog,
};
use shim_std::libc::{ENOENT, ENOSPC};
...
pub(crate) fn bpf_create_map(
    ...
    log::error!("bpf_create_map, name: {:?}, map_type: {:?}, key_size: {:?}, value_size: {:?}, max_entries: {:?}", name, u.map_type, u.key_size, u.value_size, u.max_entries);
