...
use aya_obj::{
    btf::BtfError,
    generated::{
        bpf_attach_type, bpf_prog_info, bpf_prog_type,
        bpf_prog_type::{
            ...
            BPF_PROG_TYPE_CGROUP_SYSCTL, BPF_PROG_TYPE_EXT, BPF_PROG_TYPE_KPROBE,
            BPF_PROG_TYPE_LIRC_MODE2, BPF_PROG_TYPE_LSM, BPF_PROG_TYPE_PERF_EVENT,
            BPF_PROG_TYPE_RAW_TRACEPOINT, BPF_PROG_TYPE_SCHED_CLS, BPF_PROG_TYPE_SK_LOOKUP,
            BPF_PROG_TYPE_SK_MSG, BPF_PROG_TYPE_SK_SKB, BPF_PROG_TYPE_SOCKET_FILTER,
            BPF_PROG_TYPE_SOCK_OPS, BPF_PROG_TYPE_TRACEPOINT, BPF_PROG_TYPE_TRACING,
            BPF_PROG_TYPE_XDP,
        },
    },
    obj, VerifierLog,
